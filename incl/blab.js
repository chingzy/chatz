...
htto=new Array(); mmc=1; sti_loaded=0;
...
function ad_sti(w){chat_post='[sti]'+w+'[/sti]';force_dr(0)}
...
function swap_emo(element,etitle,stitle){
ss=document.getElementById('stiset');
ee=document.getElementById('emoset');
if(element.innerHTML!=etitle){element.innerHTML=etitle;ee.style.display='none';if(sti_loaded<1){ss.innerHTML=stiset;sti_loaded=1}set_opa('stiset',1)}
else{element.innerHTML=stitle;ss.style.display='none';set_opa('emoset',1)}
}